...
public class Network extends Thread {
    ...
    private static Semaphore bufferFullIn;
    private static Semaphore bufferEmptyIn;
    private static Semaphore bufferFullOut;
    private static Semaphore bufferEmptyOut;
     ...
     Network( )
      {
         ...
         bufferFullIn = new Semaphore(0);
         bufferEmptyIn = new Semaphore(maxNbPackets);
         bufferFullOut = new Semaphore(0);
         bufferEmptyOut = new Semaphore(maxNbPackets);
      }
